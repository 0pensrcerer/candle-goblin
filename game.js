...
(function () {
  ...
  // Win sound 1: ascending major arpeggio (C5 E5 G5 C6)
  function playWin1() {
    try {
      var ctx  = getAudioCtx();
  ...
  // Win sound 2: cheerful coin collect blips
  function playWin2() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
  ...
  // Win sound 3: triumphant brass fanfare stabs
  function playWin3() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
      // Two quick stabs then a held note
  ...
  // Win sound 4: bubbly xylophone run
  function playWin4() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
  ...
  // Loss sound 1: descending minor wah-wah (Bb4 G4 Eb4 Bb3)
  function playLoss1() {
    try {
      var ctx  = getAudioCtx();
      var now  = ctx.currentTime;
  ...
  // Loss sound 2: sad trombone glide down
  function playLoss2() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
  ...
  // Loss sound 3: three descending buzzy wrong-answer blurts
  function playLoss3() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
  ...
  // Loss sound 4: descending chromatic spiral
  function playLoss4() {
    try {
      var ctx = getAudioCtx();
      var now = ctx.currentTime;
